...
function makeTr(row){
    ...
    tr.setAttribute('where',row.facilityName)
...
function openInfoWindow(e) {
    ...
    let lng = e.target.parentElement.getAttribute('lng'); //tr의 lng
    let lat = e.target.parentElement.getAttribute('lat');
    let building = e.target.parentElement.getAttribute('where');
    console.log(building);

    window.location.href = 'infowindow.html?x=' + lng+'&y=' + lat +'&where=' + building;
    //windlwo.location.href = url, 거기로 이동
}
